...
<form id="content" class="basicInfo" name="Demographics"
    ...
    <fieldset>
        ...
        <section class="consent">
            ...
            <textarea readonly>The the purpose of this experiment is to examine the relationship between different font types memory performance. You will be presented with different lists of words and your memory for these words will be studied. The words will be presented in different font types. After study, you will complete a memory test. The study is expected to last approximately 30 minutes, and you will receive 0.5 credits for completing this it. Prolific participants will be financially compensated at a rate of $10/hour USD. Aside from these types of compensation, participants can expect to learn about some of the current issues being investigated in human memory. The researchers do not expect any risks from participating in this study other than the possibility of slight boredom during task completion. Your participation will be kept confidential. Identifiable information will not be linked to the data and therefore you could not be identified based on the data. For Prolific participants, participation is anonymous as identifying information is not needed to provide compensation. For all participants, all electronic data collected will be password protected on a laboratory computers. You are free to discontinue at anytime. Your data will be deleted immediately after you withdraw. For student participants, alternative options are available at the discretion of your instructor. Please contact your instructor for information about alternative participation options. For Prolific participants, there are not alternative participation options available. This project and the consent form have been reviewed the Institutional Review Board at the University of Southern Mississippi. Any questions should be directed to anie.mitchell@usm.edu</textarea>
            <label>
